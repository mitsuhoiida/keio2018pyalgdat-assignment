...
def main():
    ...
    #English words exhibit the behavior of some words are used repeatedly,
    #especially the connecting words.
    #The class of functions that describe such behavior is the number of
    #repeatedly used words is inversely proportional to the portion of the
    #words being used within the text. The name of the law is Zipf's Law. 
    # -----
    return
